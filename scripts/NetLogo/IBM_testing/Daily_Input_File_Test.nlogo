...
to setup
  ...
  set stop_flag FALSE                 ; Set teh stop flag to F
  ...
  set flow_input_csv csv:from-file "../../../temporary/NetLogo/Depth_Data_Input_20_500.csv"   ; Read in the depth CSV
