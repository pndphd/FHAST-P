...
simulation_name = input_data["simulation name",]
```
...
```
**Fig. `r (n = n + 1)`** A scatter plot showing the relation between growth or rearing fish and number of rearing fish of fish species (`r unique(abm_summary_stats$Species)`) in the system`). <br><br><br><br>
