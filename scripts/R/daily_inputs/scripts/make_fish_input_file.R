...
# Load the functions
source("./scripts/R/daily_inputs/scripts/functions_make_the_fish_input_file.R")
...
input_file_name = paste0(input_folder,
                         input_data["folder",],
                         "/fish/",
...
write.csv(fish_schedule, 
          file = paste0(temp_folder, "NetLogo/daily_fish_input.csv"),
          row.names = FALSE)
